...
export const metadata = {
  ...
  description: "Liity pilottiin ja saa 30 päivää maksutonta käyttöä. Automatisoi yrityksesi ilman riskiä. Ensimmäiset 50 yritystä. Powered by Converto Solutions.",
}
  ...
  return (
    <>
      ...
      <Hero
        ...
        subtitle="Powered by Converto Solutions. Automatisoi yrityksesi ilman riskiä. Ensimmäiset 50 yritystä saavat käyttöönsä koko Business OS-järjestelmän ilmaiseksi 30 päiväksi."
